...
one_min_approved = Blueprint('one_min_approved', __name__,template_folder="../../templates")

@one_min_approved.route('/')
@one_min_approved.route('/1min_approved_postgres')
def count_one_min_approved_postgres():
    ...
    return render_template('1min_approved.html', context=context)


@one_min_approved.route('/1min_approved_mongo_db')
def count_one_min_approved_mongo_db():
