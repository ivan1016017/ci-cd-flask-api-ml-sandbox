...
five_min_no_approved = Blueprint('five_min_no_approved', __name__,template_folder="../../templates")

@five_min_no_approved.route('/5min_no_approved_postgres')
def count_five_min_no_approved_postgres():
    ...
    return render_template('5min_no_approved.html', context=context)


@five_min_no_approved.route('/5min_no_approved_mongo_db')
def count_five_min_no_approved_mongo_db():
